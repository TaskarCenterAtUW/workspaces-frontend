...
export class OsmChangeCache {
  ...
  async get(workspaceId: WorkspaceId, changesetId: number)
  ...
  set(workspaceId: WorkspaceId, changesetId: number, osmChange: OsmChange)
    : Promise<void>
  {
...
export class ChangesetManager {
  ...
  async getOsc(workspaceId: WorkspaceId, changeset: OsmChangeset)
    : Promise<OsmChange>
  {
    if (changeset.open) {
  ...
  async getAdiff(workspaceId: WorkspaceId, changeset: OsmChangeset)
  ...
  async #buildAdiff(workspaceId: WorkspaceId, osmChange: OsmChange)
    : Promise<AugmentedDiff>
  {
