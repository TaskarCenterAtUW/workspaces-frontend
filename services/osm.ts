...
export class OsmApiClient extends BaseHttpClient implements ICancelableClient {
  ...
  async getNodes(workspaceId: WorkspaceId, nodeIds: (number | string)[])
    : Promise<OsmNode[]>
  {
  ...
  async getWays(workspaceId: WorkspaceId, wayIds: (number | string)[])
    : Promise<OsmWay[]>
  {
  ...
  async getWaysForNode(workspaceId: WorkspaceId, nodeId: number)
    : Promise<OsmElement[]>
  {
  ...
  async getChangesetComments(workspaceId: WorkspaceId, changesetId: number)
  ...
  async getNotes(workspaceId: WorkspaceId, includeClosed: boolean)
    : Promise<OsmNote[]>
  {
