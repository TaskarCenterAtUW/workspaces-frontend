<template>
  <section class="project-wizard-step project-wizard-step-simple">
...
import type { ProjectWizardSettingsStepDefinition } from '~/types/project-wizard';
